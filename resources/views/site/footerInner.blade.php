        ...
        <div class="row">
            ...
            <div class="col-md-9 hidden-xs ">
                <ul class="footMenu text-right">
                    ...
                    <li class="footMenuLink"><a href="{{route('/')}}#products">{{trans('translate.produkciya')}}</a></li>
                    <li class="footMenuLink"><a href="{{route('/')}}#news">{{trans('translate.news')}}</a></li>
                    <li class="footMenuLink"><a href="{{route('aboutCorporateGovernance')}}">{{trans('translate.corporate')}}</a></li>
                    <li class="footMenuLink"><a href="{{route('aboutShareholders')}}">{{trans('translate.acioner')}}</a></li>
                    <li class="footMenuLink"><a href="{{route('aboutMissionAndValuess')}}">{{trans('translate.mission')}}</a></li>
                </ul>
            </div>
